...
public class listofmap_example {
    String dbUrl = "jdbc:oracle:thin:@100.26.60.119:1521:xe";
    ...
    public void test1() throws SQLException {
        ...
        //get the resulttest object metadata
        ResultSetMetaData rsmd = resultSet.getMetaData();

        //list for keeping all row a map
        ...
        //get thw steven last name directly from the list
